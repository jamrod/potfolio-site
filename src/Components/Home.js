    ...
    return (
        <div className="flex-container-row home">
            <div><img src="me.jpg" className="me-pic" />
                ...
                <p>
                    I have years of experience in tech, including management experience. An expert troubleshooter and problem solver who thrives on challenge. Getting a big skills boost at General Assembly, hoping to combine those new skills with my years of experience in health care, construction and customer service to bring solutions to complex problems.</p>
                <p>
